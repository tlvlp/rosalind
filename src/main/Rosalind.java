...
public class Rosalind {
    ...
    public static void main(String[] args) throws IOException, Exception {
        ...
        ArrayList<String> inList = FileInputParser.parseDefault(filePathIn);    // Parse the input file         - IO ERRORS ARE NOT HANDLET YET!
        ArrayList<String> outList = ModuleExecuter.launch(problemID, inList);   // Execute the selected module  - ERRORS ARE NOT HANDLET YET!
        FileOutputWriter.save(filePathOut, outList);                            // Save the output to file      - IO ERRORS ARE NOT HANDLET YET!
    }
}
